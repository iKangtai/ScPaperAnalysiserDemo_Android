...
public class CameraView extends FrameLayout {
    ...
    public void createCamera() {
        // Internal setup
        preview = createPreviewImpl(getContext());
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        state.holdCameraHigh = isHoldCameraHigh();
        return state;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setFlash(ss.flash);
        setHoldCameraHigh(ss.holdCameraHigh);
    }
    ...
    public void setHoldCameraHigh(boolean holdCameraHigh) {
        mImpl.setHoldCameraHigh(holdCameraHigh);
    }

    public boolean isHoldCameraHigh() {
        return mImpl.isHoldCameraHigh();
    }
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void onPreviewFrame(Image image) {
            for (Callback callback : mCallbacks) {
                callback.onPreviewFrame(CameraView.this, image);
            }
        }
    ...
    protected static class SavedState extends BaseSavedState {
        ...
        public SavedState(Parcel source, ClassLoader loader) {
            ...
            holdCameraHigh = source.readByte() != 0;
        }
    ...
    public abstract static class Callback {
         ...
         *
         * @param cameraView The associated {@link CameraView}.
         * @param data       – the contents of the preview frame in the format defined by ImageFormat, which can be queried with Camera.Parameters.getPreviewFormat(). If Camera.Parameters.setPreviewFormat(int) is never called, the default will be the YCbCr_420_SP (NV21) format. camera – the Camera service object.
         */
